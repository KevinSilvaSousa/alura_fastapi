...
async def pagina_listar_clientes(request: Request, cliente_repositorio: Annotated[ClienteRepositorio, Depends(obter_cliente_repositorio)]):
    ...
    return templates.TemplateResponse("clientes.html", {"request": request, "clientes": clientes, "titulo": "Lista de Clientes"})
...
async def pagina_editar_cliente(
    ...
    cliente = await cliente_repositorio.obter_clientes(cliente_id)
